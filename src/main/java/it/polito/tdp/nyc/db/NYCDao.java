...
public class NYCDao {
	...
	public List<Location> getLocations(String provider ) {
		...
		try {
			...
			while (res.next()) {
				result.add(new Location(res.getString("Location"), new LatLng(res.getDouble("latitude"),res.getDouble("longitude"))));
			}
